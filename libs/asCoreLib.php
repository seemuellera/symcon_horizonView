 ...
 * AsCoreLib:
 * ----------
 * A library with convenience functions for faster module development
 */


// needed for Dummy Module management functions
...
class AsCoreLib extends IPSModule {
    ...
    /**
     * IP Symcon Standard functions, required for the module to work
     * 
     */
    ...
    /**
     * Log Message: 
     * This part allows debug messages to be redirected to INFO, as there is currently no way to show DEBUG messages for your module
     */
    ...
    /**
     * CallAPI: A handy curl function for calling rest APIs.
     * Requries 2 properties to be registered
     * 
     */
     ...
     *   These are for my pure laziness, to keep the wording similar to Attributes and Properties.
     *   After 20 times of causing a Syntax error when using WriteValue() instead of SetValue()
     */
	...
	/**
     * generateIdent:
     *   Send a string and it gets converted to a usable ident
     * 
     */
    ...
    /**
     * This function is used to send a variable type as string and get the corresponding integer for it
     * 
     */
